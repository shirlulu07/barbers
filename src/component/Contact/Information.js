...
function Information() {
    ...
    const headStyle = "text-yellow-400 text-xl font-crimson"
    ...
    return (
        <div className='flex flex-col sm:flex-row sm:justify-between py-5'>
            <div className='flex flex-col gap-2'>
                ...
                <div className='flex gap-1'>
                    <svg xmlns="http://www.w3.org/2000/svg" pp1 height="0.75rem" viewBox="0 0 24 24" width="0.75rem" fill="#d9a520"><path d="M0 0h24v24H0z" fill="none" /><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg><p className={textStyle}>youremail@gmail.com</p>
                </div>
            </div>
            <div className='flex flex-col gap-2'>
