...
function AboutUs() {
    ...
    const textStyle = "text-sm text-gray-400 font-poppins"
    ...
    return (
        <div className='px-10 py-20 sm:px-40 sm:flex sm:flex-row sm:justify-evenly gap-10 items-center' id='aboutUs'>
            ...
            <div className='flex flex-col gap-10 sm:w-1/2 py-5'>
                ...
                <div className=''>
                    <p className={textStyle}>Lorem ipsum dolorsit amet, consectetur adipisicing elit, sed do eiusmod
            ...
            <img src={Img1} className=" sm:h-96 sm:w-1/2" />
